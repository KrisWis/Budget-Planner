...
create_question__add_answer.addEventListener("click", function () {
    ...
    /* Создание вопроса */
    const create_question__request = `<div class="create_question__answer_types" id="create_question__answer_types--${create_question__answers_count}">
...
create_question.addEventListener("click", function () {
    ...
    /* Создание вопроса */
    const create_question__request = `<div class="create_question_active">
    ...
    create_question__add_answer.addEventListener("click", function () {
        create_question__answers_count++;
        /* Создание вопроса */
        const create_question__request = `<div class="create_question__answer_types" id="create_question--${create_question__count}__answer_types--${create_question__answers_count}">
