<html lang="en">
  <head>
    ...
    <?php 
      ...
      // wp_head() - подключит все файлы для хедера, которые написаны в functions.php.
      wp_head()
  ...
  <div class="js-animsition animsition" data-animsition-in-class="fade-in" data-animsition-out-class="fade-out">
    ...
    <header class="templateux-navbar navbar-light" data-aos="fade-down">
      <div class="container-fluid">
        <div class="row">
          <!-- href="/" переносит пользователя на главную страницу. -->
          ...
          <div class="col-sm-9 col-9 text-right">
            ...
            <nav class="templateux-menu js-templateux-menu" role="navigation">
              <!-- Получаем и выводим наше меню навигации, которое добавили в WordPress. -->
              <?php wp_nav_menu( [
              'theme_location'  => '',
              'menu'            => '',
              'container'       => 'div',
