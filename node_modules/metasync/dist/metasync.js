...
var nodeVerion = common.between(process.version, 'v', '.');
var submodules = ['composition', // Unified abstraction
...
var compose = submodules[0].compose;
module.exports = Object.assign.apply(Object, [compose].concat(_toConsumableArray(submodules)));